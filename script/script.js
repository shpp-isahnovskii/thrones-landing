...
function gotToNextForm() {
  ...
  document.getElementById('formOne').classList.add('invisible');
  document.getElementById('formTwo').classList.remove('invisible');

  /* part of PS3 - carousele. Add it */
  $('.left-section').css('background-image', 'none');
  $('.left-section').append("<div class='owl-carousel'></div>");
  addCarousel();
  onChangeTriggers();
}
